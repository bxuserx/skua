...
// entirely skua's own, and these schemes are it.
//
...
// `skua-theme` key.) Palettes are the upstream/canonical values for each.
...
(function () {
    const SCHEMES = {
        "aizen-dark": {
            ...
            // skua-vim-setup builds via mini.base16 — terminal and editor match.
            label: "Aizen Dark",
            theme: {
                background: "#1a1a1a",
                foreground: "#d0d6f0",
    ...
    window.SKUA_TERM_SCHEMES = SCHEMES;
    window.SKUA_TERM_SCHEME_DEFAULT = DEFAULT;
    window.SKUA_TERM_SCHEME_KEY = "skua-term-scheme";
    ...
    window.skuaTermScheme = function (id) {
